...
<ul>
	...
	<li>Only show share buttons after post contents.(See FAQs for why don't show buttons on Page and HomePage)</li>
</ul>
...
<ul>
	...
	<li>To display buttons on Homepage, change them to <strong>if(is_single()||is_home())</strong></li>
	<li>To display buttons on Posts, pages and Homepage,change them to <strong>if(is_single()||is_page()||is_home())out</strong></li>
</ul>
