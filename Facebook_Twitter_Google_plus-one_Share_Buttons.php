...
Description: This simple and easy-to-use plugin adds facebook,twitter,google +1(plus one) and many other popular social sharing buttons after post contents,such as:Stumbleupon,Linkedin,Digg
Version: 1.2.2
Author: Jeriff Cheng
...
<ul id="socialbuttonnav" style="list-style:none;width:90%; overflow:hidden;margin:0 auto;">
...
<li><!-- Facebook like--><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="" send="false" layout="box_count" width="64" show_faces="false" action="like" font=""></fb:like></li>
</ul>';
}
return $content;
}
